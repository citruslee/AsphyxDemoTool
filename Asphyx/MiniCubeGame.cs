    ...
    public class MiniCubeGame : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            vertices = ToDisposeContent(Buffer.Vertex.New(
                ...
                new[]
                    {
                        new VertexPositionColor(new Vector3(-1.0f, -1.0f, 1.0f), Color.AliceBlue), // Back
                        new VertexPositionColor(new Vector3(-1.0f, 1.0f, 1.0f), Color.Orange),
                        new VertexPositionColor(new Vector3(1.0f, 1.0f, 1.0f), Color.CornflowerBlue),
                        new VertexPositionColor(new Vector3(-1.0f, -1.0f, 1.0f), Color.Orchid),
                        new VertexPositionColor(new Vector3(1.0f, 1.0f, 1.0f), Color.PaleGoldenrod),
                        new VertexPositionColor(new Vector3(1.0f, -1.0f, 1.0f), Color.OliveDrab),
